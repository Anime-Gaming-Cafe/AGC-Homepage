export const GUILD_ID = process.env.DISCORD_GUILD_ID ?? "750365461945778209";
export const STAFF_ROLE_ID =
  process.env.DISCORD_STAFF_ROLE_ID ?? "771734897475059753";
...
export const BACK_DESC_MAX = 450;

export const PAGE_DESCRIPTION_MAX = 300;
export const PAGE_INFORMATION_MAX = 4000;

export const PARTNER_NAME_MAX = 60;
export const PARTNER_TAGLINE_MAX = 150;
export const PARTNER_DESCRIPTION_MAX = 300;
export const PARTNER_URL_MAX = 300;
